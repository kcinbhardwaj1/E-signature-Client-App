...
<body>
	<form action="/templateDetailsOfEmbed/${templateId}" method="get"
		data-busy="form">
		<div class="table-title" align="center">

			<h1>Send an envelope with an embedded signer</h1>
			<p>Use Template for embedding</p>

			<c:choose>
				<c:when test="${empty done}">

					<h2>
						Use Template for embedding in Process... <img id="loading-image"
				...
				<c:when test="${not empty done}">
					<table class="table-fill" border="2" cellpadding="5">
						...
						<tr>
							...
							<td class="text-left"><select id="templateId"
								name="templateId" class="form-control">
